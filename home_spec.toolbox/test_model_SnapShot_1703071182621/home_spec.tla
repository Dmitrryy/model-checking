...
\* BEGIN TRANSLATION (chksum(pcal) = "49818d9c" /\ chksum(tla) = "1bc23f50")
...
ProcSet == {"Owner"} \cup ({"armedStay", "armedAway", "disarmed"}) \cup ({1})
...
Spec == /\ Init /\ [][Next]_vars
        ...
        /\ \A self \in {1} : WF_vars(Camera(self))
...
\* Last modified Wed Dec 20 14:19:21 MSK 2023 by dadro
